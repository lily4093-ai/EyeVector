...
@Mod(value = EyeVectorMod.MODID, dist = Dist.CLIENT)
public class EyeVectorMod {
	public static final String MODID = "eyevector";
	...
	public EyeVectorMod(IEventBus modEventBus) {
		NeoForge.EVENT_BUS.register(this);
	}

	@SubscribeEvent
	public void onRegisterCommands(RegisterClientCommandsEvent event) {
		EyeVectorCommand.register(event.getDispatcher(), event.getBuildContext());
	}
